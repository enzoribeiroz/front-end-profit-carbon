...
import 'dashboard_produtor_model.dart';
export 'dashboard_produtor_model.dart';

class DashboardProdutorWidget extends StatefulWidget {
  const DashboardProdutorWidget({super.key});

  @override
  State<DashboardProdutorWidget> createState() =>
      _DashboardProdutorWidgetState();
}

class _DashboardProdutorWidgetState extends State<DashboardProdutorWidget>
    with TickerProviderStateMixin {
  late DashboardProdutorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardProdutorModel());
