...
import 'novo_terreno_cooperativa_model.dart';
export 'novo_terreno_cooperativa_model.dart';

class NovoTerrenoCooperativaWidget extends StatefulWidget {
  const NovoTerrenoCooperativaWidget({super.key});

  @override
  State<NovoTerrenoCooperativaWidget> createState() =>
      _NovoTerrenoCooperativaWidgetState();
}

class _NovoTerrenoCooperativaWidgetState
    extends State<NovoTerrenoCooperativaWidget> {
  late NovoTerrenoCooperativaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NovoTerrenoCooperativaModel());
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    options: [
                                      'Até 1.000 Hectares',
                                      'Entre 1.001 e 5.000 Hectares',
                                      'Entre 5.001 e 10.000 Hectares',
                                      'Entre 10.001 e 15.000 Hectares',
                                      'Entre 15.001 e 20.000 Hectares',
                                      'A partir de 20.000 Hectares'
                                    ],
